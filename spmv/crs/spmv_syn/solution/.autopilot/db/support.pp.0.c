...
static inline int fd_printf(int fd, const char *format, ...) {
  ...
  ({ int _AssertPred = buffered<256 && "Overran fd_printf buffer---output possibly corrupt"; __builtin_assume(_AssertPred); });
  written = 0;
  VITIS_LOOP_24_1: while(written<buffered) {
    status = write(fd, &buffer[written], buffered-written);
    ({ int _AssertPred = status>=0 && "Write failed"; __builtin_assume(_AssertPred); });
    written += status;
  }
  ({ int _AssertPred = written==buffered && "Wrote more data than given"; __builtin_assume(_AssertPred); });
  return written;
}
...
char *readfile(int fd) {
  ...
  ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); });
  ({ int _AssertPred = 0==fstat(fd, &s) && "Couldn't determine file size"; __builtin_assume(_AssertPred); });
  len = s.st_size;
  ({ int _AssertPred = len>0 && "File is empty"; __builtin_assume(_AssertPred); });
  p = (char *)malloc(len+1);
  bytes_read = 0;
  VITIS_LOOP_46_1: while( bytes_read<len ) {
    status = read(fd, &p[bytes_read], len-bytes_read);
    ({ int _AssertPred = status>=0 && "read() failed"; __builtin_assume(_AssertPred); });
    bytes_read+=status;
  }
  p[len] = (char)0;
  close(fd);
...
char *find_section_start(char *s, int n) {
  ...
  ({ int _AssertPred = n>=0 && "Invalid section number"; __builtin_assume(_AssertPred); });
  if(n==0)
    return s;


  VITIS_LOOP_64_1: while(i<n && (*s)!=(char)0) {
...
int parse_string(char *s, char *arr, int n) {
  int k;
  ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); });

  if( n<0 ) {
    k = 0;
    VITIS_LOOP_83_1: while( s[k]!=(char)0 && s[k+1]!=(char)0 && s[k+2]!=(char)0
        && !(s[k]=='\n' && s[k+1]=='%' && s[k+2]=='%') ) {
      k++;
    }
  } else {
...
# 132 "support.c"
int parse_uint8_t_array(char *s, uint8_t *arr, int n) { char *line, *endptr; int i=0; uint8_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_132_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (uint8_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_uint16_t_array(char *s, uint16_t *arr, int n) { char *line, *endptr; int i=0; uint16_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_133_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (uint16_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_uint32_t_array(char *s, uint32_t *arr, int n) { char *line, *endptr; int i=0; uint32_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_134_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (uint32_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_uint64_t_array(char *s, uint64_t *arr, int n) { char *line, *endptr; int i=0; uint64_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_135_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (uint64_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_int8_t_array(char *s, int8_t *arr, int n) { char *line, *endptr; int i=0; int8_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_136_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (int8_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_int16_t_array(char *s, int16_t *arr, int n) { char *line, *endptr; int i=0; int16_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_137_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (int16_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_int32_t_array(char *s, int32_t *arr, int n) { char *line, *endptr; int i=0; int32_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_138_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (int32_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_int64_t_array(char *s, int64_t *arr, int n) { char *line, *endptr; int i=0; int64_t v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_139_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (int64_t)(strtol(line,&endptr,10)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }

int parse_float_array(char *s, float *arr, int n) { char *line, *endptr; int i=0; float v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_141_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (float)(strtof(line, &endptr)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
int parse_double_array(char *s, double *arr, int n) { char *line, *endptr; int i=0; double v; ({ int _AssertPred = s!=((void*)0) && "Invalid input string"; __builtin_assume(_AssertPred); }); line = strtok(s,"\n"); VITIS_LOOP_142_1: while( line!=((void*)0) && i<n ) { endptr = line; v = (double)(strtod(line, &endptr)); if( (*endptr)!=(char)0 ) { fprintf(stderr, "Invalid input: line %d of section\n", i); } arr[i] = v; i++; line[strlen(line)] = '\n'; line = strtok(((void*)0),"\n"); } if(line!=((void*)0)) { line[strlen(line)] = '\n'; } return 0; }
...
int write_string(int fd, char *arr, int n) {
  ...
  written = 0;
  VITIS_LOOP_152_1: while(written<n) {
...
# 177 "support.c"
int write_uint8_t_array(int fd, uint8_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_177_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "u" "\n", arr[i]); } return 0; }
int write_uint16_t_array(int fd, uint16_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_178_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "u" "\n", arr[i]); } return 0; }
int write_uint32_t_array(int fd, uint32_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_179_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "u" "\n", arr[i]); } return 0; }
int write_uint64_t_array(int fd, uint64_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_180_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "l" "u" "\n", arr[i]); } return 0; }
int write_int8_t_array(int fd, int8_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_181_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "d" "\n", arr[i]); } return 0; }
int write_int16_t_array(int fd, int16_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_182_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "d" "\n", arr[i]); } return 0; }
int write_int32_t_array(int fd, int32_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_183_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "d" "\n", arr[i]); } return 0; }
int write_int64_t_array(int fd, int64_t *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_184_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" "l" "d" "\n", arr[i]); } return 0; }

int write_float_array(int fd, float *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_186_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" ".16f" "\n", arr[i]); } return 0; }
int write_double_array(int fd, double *arr, int n) { int i; ({ int _AssertPred = fd>1 && "Invalid file descriptor"; __builtin_assume(_AssertPred); }); VITIS_LOOP_187_1: for( i=0; i<n; i++ ) { fd_printf(fd, "%" ".16f" "\n", arr[i]); } return 0; }

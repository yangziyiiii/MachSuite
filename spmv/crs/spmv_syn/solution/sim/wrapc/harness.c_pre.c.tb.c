...
// 
// ==============================================================
# 1 "/home/yzy/MachSuite/common/harness.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 349 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/yzy/MachSuite/common/harness.c" 2
...
# 2 "/home/yzy/MachSuite/common/harness.c" 2
...
# 3 "/home/yzy/MachSuite/common/harness.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 4 "/home/yzy/MachSuite/common/harness.c" 2
...
# 5 "/home/yzy/MachSuite/common/harness.c" 2
...
# 6 "/home/yzy/MachSuite/common/harness.c" 2
...
# 7 "/home/yzy/MachSuite/common/harness.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 8 "/home/yzy/MachSuite/common/harness.c" 2




# 1 "/home/yzy/MachSuite/common/support.h" 1
...
extern uintmax_t wcstoumax (const __gwchar_t *__restrict __nptr,
       __gwchar_t ** __restrict __endptr, int __base)
     __attribute__ ((__nothrow__ ));
# 3 "/home/yzy/MachSuite/common/support.h" 2
...
# 76 "/home/yzy/MachSuite/common/support.h"
struct prng_rand_t {
  uint64_t s[((1)<<6)];
  uint_fast16_t i;
  uint_fast16_t c;
...
# 13 "/home/yzy/MachSuite/common/harness.c" 2


#ifndef HLS_FASTSIM
# 14 "/home/yzy/MachSuite/common/harness.c"
int main(int argc, char **argv)
{
  ...
  ((void) sizeof ((argc<4 && "Usage: ./benchmark <input_file> <check_file>") ? 1 : 0), __extension__ ({ if (argc<4 && "Usage: ./benchmark <input_file> <check_file>") ; else __assert_fail ("argc<4 && \"Usage: ./benchmark <input_file> <check_file>\"", "/home/yzy/MachSuite/common/harness.c", 21, __extension__ __PRETTY_FUNCTION__); }));
  in_file = "input.data";
  ...
  ((void) sizeof ((data!=((void*)0) && "Out of memory") ? 1 : 0), __extension__ ({ if (data!=((void*)0) && "Out of memory") ; else __assert_fail ("data!=NULL && \"Out of memory\"", "/home/yzy/MachSuite/common/harness.c", 37, __extension__ __PRETTY_FUNCTION__); }));
  in_fd = open( in_file, 00 );
  ((void) sizeof ((in_fd>0 && "Couldn't open input data file") ? 1 : 0), __extension__ ({ if (in_fd>0 && "Couldn't open input data file") ; else __assert_fail ("in_fd>0 && \"Couldn't open input data file\"", "/home/yzy/MachSuite/common/harness.c", 39, __extension__ __PRETTY_FUNCTION__); }));
  ...
  ((void) sizeof ((out_fd>0 && "Couldn't open output data file") ? 1 : 0), __extension__ ({ if (out_fd>0 && "Couldn't open output data file") ; else __assert_fail ("out_fd>0 && \"Couldn't open output data file\"", "/home/yzy/MachSuite/common/harness.c", 48, __extension__ __PRETTY_FUNCTION__); }));
  ...
  ((void) sizeof ((ref!=((void*)0) && "Out of memory") ? 1 : 0), __extension__ ({ if (ref!=((void*)0) && "Out of memory") ; else __assert_fail ("ref!=NULL && \"Out of memory\"", "/home/yzy/MachSuite/common/harness.c", 58, __extension__ __PRETTY_FUNCTION__); }));
  check_fd = open( check_file, 00 );
  ((void) sizeof ((check_fd>0 && "Couldn't open check data file") ? 1 : 0), __extension__ ({ if (check_fd>0 && "Couldn't open check data file") ; else __assert_fail ("check_fd>0 && \"Couldn't open check data file\"", "/home/yzy/MachSuite/common/harness.c", 60, __extension__ __PRETTY_FUNCTION__); }));
...
#endif
# 76 "/home/yzy/MachSuite/common/harness.c"

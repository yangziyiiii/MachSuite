...
module AESL_automem_rowDelimiters (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.spmv.autotvin_rowDelimiters.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.spmv.autotvout_rowDelimiters.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 9;
parameter DEPTH = 32'd 495;
parameter DLY = 0.1;

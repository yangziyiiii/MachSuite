...
// 
// ==============================================================
# 1 "/home/yzy/MachSuite/spmv/crs/spmv.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 349 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/yzy/MachSuite/spmv/crs/spmv.c" 2
...
# 7 "/home/yzy/MachSuite/spmv/crs/spmv.c" 2

void spmv(double val[1666], int32_t cols[1666], int32_t rowDelimiters[494 +1], double vec[494], double out[494]){
    int i, j;
    double sum, Si;
...
extern "C"
#endif
void apatb_spmv_ir(double *, int *, int *, double *, double *);
#ifdef __cplusplus
extern "C"
#endif
void spmv_hw_stub(double *val, int *cols, int *rowDelimiters, double *vec, double *out){
...
extern "C"
#endif
void apatb_spmv_sw(double *val, int *cols, int *rowDelimiters, double *vec, double *out){
refine_signal_handler();
apatb_spmv_ir(val, cols, rowDelimiters, vec, out);
return ;
}
#endif
# 22 "/home/yzy/MachSuite/spmv/crs/spmv.c"
